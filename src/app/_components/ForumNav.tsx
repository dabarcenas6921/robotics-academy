      ...
      <div className="flex flex-col sm:flex-row items-center w-full md:w-auto mb-4 md:mb-0 flex-grow gap-4">
        {session?.user && (
          <div>
            <Link
              ...
              passHref
              className="py-2 sm:py-3 px-3 sm:px-4 w-full sm:w-auto inline-flex justify-center items-center gap-2 rounded-md font-medium text-white bg-lime-500 shadow-sm hover:bg-lime-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all text-sm sm:text-md flex-shrink-0"
            >
              Start a new topic
            </Link>
          </div>
        ...
        <div className="flex w-full sm:w-auto rounded-md shadow-sm flex-grow">
          <input
            ...
            className="flex-grow py-2 sm:py-3 px-3 sm:px-4 block w-full shadow-sm rounded-l-md text-sm sm:text-md focus:z-10 border-gray-700 text-gray-800"
