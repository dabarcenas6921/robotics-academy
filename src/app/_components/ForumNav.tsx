export default function ForumNav() {
  return (
    <div className="max-w-[85rem] w-full px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto flex flex-col md:flex-row items-center justify-between flex-wrap">
      <div className="flex flex-col sm:flex-row gap-4 items-center w-full md:w-auto mb-4 md:mb-0">
        <button
          type="button"
          className="py-2 sm:py-3 px-3 sm:px-4 w-full sm:w-auto inline-flex justify-center items-center gap-2 rounded-md font-medium text-white bg-gold shadow-sm hover:bg-opacity-90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gold transition-all text-sm sm:text-md"
        >
          Start a new topic
        </button>
        ...
        <div className="flex w-full sm:w-auto rounded-md shadow-sm">
          <input
            ...
            className="py-2 sm:py-3 px-3 sm:px-4 block w-full shadow-sm rounded-l-md text-sm sm:text-md focus:z-10 border-gray-700 text-gray-800"
        ...
        <li className="inline-flex items-center gap-x-2.5 py-3 px-4 text-sm font-medium bg-white border text-gray-800 -mt-px first:rounded-t-lg first:mt-0 last:rounded-b-lg sm:-ml-px sm:mt-0 sm:first:rounded-tr-none sm:first:rounded-bl-lg sm:last:rounded-bl-none sm:last:rounded-tr-lg">
          <button className="flex items-center gap-x-2.5 focus:outline-none">
            <svg
              ...
              fill="currentColor"
            >
              <path d="M15 14s1 0 1-1-1-4-5-4-5 3-5 4 1 1 1 1h8zm-7.978-1A.261.261 0 0 1 7 12.996c.001-.264.167-1.03.76-1.72C8.312 10.629 9.282 10 11 10c1.717 0 2.687.63 3.24 1.276.593.69.758 1.457.76 1.72l-.008.002a.274.274 0 0 1-.014.002H7.022zM11 7a2 2 0 1 0 0-4 2 2 0 0 0 0 4zm3-2a3 3 0 1 1-6 0 3 3 0 0 1 6 0zM6.936 9.28a5.88 5.88 0 0 0-1.23-.247A7.35 7.35 0 0 0 5 9c-4 0-5 3-5 4 0 .667.333 1 1 1h4.216A2.238 2.238 0 0 1 5 13c0-1.01.388-2.026 1.06-2.79a5.074 5.074 0 0 1 1.874-1.23zM5 15H2c-.542 0-.859-.418-.995-.91l-.005-.17C1 13.216 1.768 11 5 11c.357 0 .701.02 1.038.057a6.71 6.71 0 0 0-.095 1.142 3.22 3.22 0 0 0 1.57-.637A8.07 8.07 0 0 1 5 12c-2.88 0-3.387 1.534-3.433 1.66A.237.237 0 0 0 2 14h3a2 2 0 0 1-2 2v1a3 3 0 0 0 3-3z" />
            </svg>
            My Discussions
          </button>
        </li>
